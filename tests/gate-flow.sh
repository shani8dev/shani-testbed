...
check "iso: launchers checked on ISO install"    "has 'CALL slot_test blue boot-health fresh-user launchers'"
...
check "upgrade: no launchers on R2 install"      "has 'CALL slot_test green boot-health fresh-user'"
